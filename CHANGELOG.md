...
## [8.4.1](https://github.com/cademirch/snakemake/compare/v8.25.5...v8.4.1) (2024-12-16)
...
* allow environment variables in string values of profile (e.g. paths may now contain elements like $USER). ([58dc70c](https://github.com/cademirch/snakemake/commit/58dc70c513d08cb217647ec591df93b40517b650))
...
* allow python expressions in --set-resources ([#2521](https://github.com/cademirch/snakemake/issues/2521)) ([022a31e](https://github.com/cademirch/snakemake/commit/022a31e0e75416904589c62b58e54c952d930c69))
...
* version specific profile config files (profile/config.v8+.yaml with profile/config.yaml as fallback that matches any version) ([#2498](https://github.com/cademirch/snakemake/issues/2498)) ([47e5811](https://github.com/cademirch/snakemake/commit/47e581181f952884577f0237a1aa9457ee9554dd))
...
* assume at most 8GB memory for default resources. This way, we avoid exploding memory requirements for large input files that are very unlikely to be put entirely into memory by any tool. ([11c2ecc](https://github.com/cademirch/snakemake/commit/11c2eccfa72a2732d20a66bbf57995ee9dfd14ae))
...
* ensure that auto deployment of default storage provider works in containers with read-only root home. ([1a347ff](https://github.com/cademirch/snakemake/commit/1a347ffd8b2144aee5c35ea17fec2262c5cc9c40))
...
* fix cache handling and unlock handling ([2f4d5e1](https://github.com/cademirch/snakemake/commit/2f4d5e11b36f199d3335839e9b5dc5d2094d11f8))
...
* fix path handling when detective profiles ([fe63881](https://github.com/cademirch/snakemake/commit/fe63881371036fc6d55e6a113cb3ed5029b31d2d))
...
* fix storage handling on windows by converting all paths to posix paths ([#2519](https://github.com/cademirch/snakemake/issues/2519)) ([7864a76](https://github.com/cademirch/snakemake/commit/7864a76c41ad7839fb3b9aeb1c4468215ba0cb21))
...
* handle different f-string tokens in py3.12 ([#2485](https://github.com/cademirch/snakemake/issues/2485)) ([f2c7613](https://github.com/cademirch/snakemake/commit/f2c761320a5a73d6027ae3649843e6bf6a24f324))
...
* use temporary directory (faster, more likely local, always writable) for persistence and source cache in case of remote execution without shared fs ([#2502](https://github.com/cademirch/snakemake/issues/2502)) ([c8fa7ba](https://github.com/cademirch/snakemake/commit/c8fa7ba3ee70c9c62011a3839758a5eb8fde16f8))
...
* notes on arm based machines in tutorial docs ([0586f04](https://github.com/cademirch/snakemake/commit/0586f04d2b03443a25deddd017f303156acdcd9c))
