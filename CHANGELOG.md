...
## [8.4.1](https://github.com/cademirch/snakemake/compare/v8.28.0...v8.4.1) (2025-02-20)
...
* add option to control software deployment mode (shared or non shared FS) ([#2525](https://github.com/cademirch/snakemake/issues/2525)) ([04ec2c0](https://github.com/cademirch/snakemake/commit/04ec2c0262b2cb96cbcd7edbbb2596979c1703ae))
...
* allow detailed configuration of shared FS usage ([#2528](https://github.com/cademirch/snakemake/issues/2528)) ([0d34be9](https://github.com/cademirch/snakemake/commit/0d34be90040f937021eb25becb4ef5d5aae66473))
...
* add testcase for script directive to work with Python 3.7 and corresponding fix. ([0b4ae2e](https://github.com/cademirch/snakemake/commit/0b4ae2e1155378a78e0786ad4dfd5d44fa41c9ae))
...
* detect job paths that leave and then enter a group. Such paths are invalid because then the group depends on itself. ([#2527](https://github.com/cademirch/snakemake/issues/2527)) ([5383a4d](https://github.com/cademirch/snakemake/commit/5383a4d85f8b7a3fb61fd0b457fcd1d008c2255f))
...
* ensure that log and benchmark files are uploaded to storage as well ([#2545](https://github.com/cademirch/snakemake/issues/2545)) ([6aabb5d](https://github.com/cademirch/snakemake/commit/6aabb5db16634c077ba808dbd000a3ed67d6a3c0))
...
* handle storage for local jobs; add test case ([6d978ef](https://github.com/cademirch/snakemake/commit/6d978ef31060393bd3a69b7973170e3c79473705))
...
* improved error handling for storage upload; fixed bugs caused by outdated calls to IOFile.exists(). ([720bb84](https://github.com/cademirch/snakemake/commit/720bb8400ecf8e6c3caf3ca6b47d7dda4f1f7ba9))
* improved error messages in case of invalid storage queries ([9671fd0](https://github.com/cademirch/snakemake/commit/9671fd0770fbe2d79d3546ca5f19c8fc39ffc25a))
...
* in addition to localrules statement,  infer that job is local if it has any input or output file that is marked as local ([#2541](https://github.com/cademirch/snakemake/issues/2541)) ([e8b682b](https://github.com/cademirch/snakemake/commit/e8b682be0bd52a01ec3ebdbbcb1ec018950819b2))
...
* only deactivate conda inject envs upon workflow tear down ([#2503](https://github.com/cademirch/snakemake/issues/2503)) ([e6dfdd4](https://github.com/cademirch/snakemake/commit/e6dfdd49cbaad228827f62a48cfe6419e4c1715e))
...
* Panoptes --wms-monitor-arg ([#2444](https://github.com/cademirch/snakemake/issues/2444)) ([98d2bdf](https://github.com/cademirch/snakemake/commit/98d2bdfd1e3aeddf189b272d3e4042632248c10f))
...
* shadow "full" mode ignore symlinks ([#2516](https://github.com/cademirch/snakemake/issues/2516)) ([1d58120](https://github.com/cademirch/snakemake/commit/1d5812027e5d1a8d5f2e45175fa38d28ca32763e))
...
* Slack log service ([#2537](https://github.com/cademirch/snakemake/issues/2537)) ([26eb4ba](https://github.com/cademirch/snakemake/commit/26eb4babc28464a24c33d75703e7bf4f15c0e33f))
...
* document name directive with example ([#2534](https://github.com/cademirch/snakemake/issues/2534)) ([cce5551](https://github.com/cademirch/snakemake/commit/cce555142814f5bd1d73e68b9a17b772454817d4))
